...
public class Main {
    ...
    public static void listarAutores() {
        ...
        List<Autor> autores = dao.getAll(nameQuery: "autores.All", Autor.class);
        autores.forEach(Autor autor -> System.out.println(autor.getNombre()));
    }

    public static void editarAutor() {
        Autor a = new Autor();
        a = dao.findById(id: 1, Autor.class);
        a.setNacionalidad("Colombiana"); Nota: Esto sobrescribe la nacionalidad "Mexicana"
        dao.update(a);
    }

    public static void eliminarAutor() {
        Autor a = new Autor();
        a = dao.findById(id: 2, Autor.class);
        dao.delete(a);
    }
